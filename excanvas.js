...
(function() {
    ...
    initElement: function(el) {
      if (!el.getContext) {
        ...
        if (attrs.width && attrs.width.specified) {
          ...
          el.style.width = attrs.width.nodeValue.substr(1,attrs.width.nodeValue.length-2);
        } else {
        ...
        if (attrs.height && attrs.height.specified) {
          ...
          el.style.height = attrs.height.nodeValue.substr(1,attrs.height.nodeValue.length-2);
        } else {
  ...
  contextPrototype.fillText = function(textToDraw, x, y) {
    ...
    vmlStr.push('<g_vml_:shape style="font:' + this.font + ';',
                    ...
                    ' position:absolute;',
                    ' left:' + (x - textToDraw.toString().length * textHeight / 4) + 'px;',
                    ' top:' + (y - textHeight / 2) + 'px;',
